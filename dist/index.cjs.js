...
var Icon$1o = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default['default'].createElement("image", { href: '/images/guitarimg/logo.png' })));
};
...
var Icon$17 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 256 256" }, props),
        React__default['default'].createElement("image", { href: '/images/guitarimg/gut-token.png' })));
};
        ...
        React__default['default'].createElement(Flex, { justifyContent: "flex-end" },
            ...
            switchEditingUnits && (React__default['default'].createElement(Flex, { alignItems: "center", pl: "12px" },
                React__default['default'].createElement(SwitchUnitsButton, { scale: "sm", variant: "text", onClick: switchEditingUnits },
                    React__default['default'].createElement(Icon$Q, { color: "textSubtle" })))))));
};
...
var StyledBunnyPlaceholder = styled__default['default'](Icon$1Q)(templateObject_2$o || (templateObject_2$o = __makeTemplateObject(["\n  height: 100%;\n  width: 100%;\n"], ["\n  height: 100%;\n  width: 100%;\n"])));
...
var MessageContainer = styled__default['default'].div(templateObject_1$F || (templateObject_1$F = __makeTemplateObject(["\n  display: flex;\n  background-color: gray;\n  padding: 16px;\n  border-radius: 16px;\n  border: solid 1px;\n\n  ", "\n  ", "\n"], ["\n  display: flex;\n  background-color: gray;\n  padding: 16px;\n  border-radius: 16px;\n  border: solid 1px;\n\n  ", "\n  ",
...
var SliderLabelContainer = styled__default['default'].div(templateObject_1$y || (templateObject_1$y = __makeTemplateObject(["\n  bottom: 0;\n  position: absolute;\n  left: 14px;\n  width: calc(100% - 30px);\n"], ["\n  bottom: 0;\n  position: absolute;\n  left: 14px;\n  width: calc(100% - 30px);\n"])));
...
var StepperWrapper = styled__default['default'].div(templateObject_1$v || (templateObject_1$v = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  width: fit-content;\n"], ["\n  display: flex;\n  flex-direction: column;\n  width: fit-content;\n"])));
...
var StyledStep = styled__default['default'](Flex)(templateObject_1$u || (templateObject_1$u = __makeTemplateObject(["\n  ", " {\n    justify-content: center;\n  }\n"], ["\n  ", " {\n    justify-content: center;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
});
...
var SubMenuContainer = styled__default['default'].div(templateObject_1$t || (templateObject_1$t = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n  min-width: 136px;\n  background: ", ";\n  border-radius: ", ";\n  border: ", ";\n"], ["\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n  min-width: 136px;\n  background: ", ";\n  border-radius: ", ";\n  border: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.input;
}, function (_a) {
    var theme = _a.theme;
...
var Td = styled__default['default'].td(templateObject_1$s || (templateObject_1$s = __makeTemplateObject(["\n  border-bottom: 1px solid ", ";\n  color: ", ";\n  padding: 16px;\n  vertical-align: middle;\n\n  ", "\n"], ["\n  border-bottom: 1px solid ", ";\n  color: ", ";\n  padding: 16px;\n  vertical-align: middle;\n\n  ", "\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.cardBorder;
}, function (_a) {
    var theme = _a.theme;
...
var Table = styled__default['default'].table(templateObject_1$r || (templateObject_1$r = __makeTemplateObject(["\n  max-width: 100%;\n  width: 100%;\n\n  tbody tr:last-child {\n    ", " {\n      border-bottom: 0;\n    }\n  }\n\n  ", "\n"], ["\n  max-width: 100%;\n  width: 100%;\n\n  tbody tr:last-child {\n    ", " {\n      border-bottom: 0;\n    }\n  }\n\n  ", "\n"])), Td, styledSystem.space);
var templateObject_1$r;
...
var Wrapper$1 = styled__default['default'](Flex)(templateObject_1$q || (templateObject_1$q = __makeTemplateObject(["\n  border-bottom: 2px solid ", ";\n  overflow-x: scroll;\n\n  ::-webkit-scrollbar {\n    display: none;\n  }\n  -ms-overflow-style: none; /* IE and Edge */\n  scrollbar-width: none; /* Firefox */\n"], ["\n  border-bottom: 2px solid ", ";\n  overflow-x: scroll;\n\n  ::-webkit-scrollbar {\n    display: none;\n  }\n  -ms-overflow-style: none; /* IE and Edge */\n  scrollbar-width: none; /* Firefox */\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.textSubtle;
});
...
var Logo$2 = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 785 300" }, props),
        React__default['default'].createElement("image", { href: isDark ? '/images/guitarimg/LogoDark.png' : '/images/guitarimg/LogoWhite.png' })));
};
...
var Icon$a = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("image", { href: '/images/guitarimg/github.png' })));
};
...
var blink = styled.keyframes(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["\n  0%,  100% { transform: scaleY(1); } \n  50% { transform:  scaleY(0.1); } \n"], ["\n  0%,  100% { transform: scaleY(1); } \n  50% { transform:  scaleY(0.1); } \n"])));
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://bscscan.com/token/0xb6bA8c98021C31A02DD65e9bE97729EbA859d4E2", target: "_blank" },
...
var LangSelector = function (_a) {
    ...
    return (React__default['default'].createElement(Dropdown, { position: "top-right", target: React__default['default'].createElement(Button, { variant: "text", startIcon: React__default['default'].createElement(Icon$1u, { color: "textSubtle", width: "24px" }) },
...
var AuditSection = styled__default['default'].div(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["\n  display: ", ";\n  gap: 5px;\n  padding: 0 5px;\n\n  & > * {\n    flex: 1;\n  }\n"], ["\n  display: ", ";\n  gap: 5px;\n  padding: 0 5px;\n\n  & > * {\n    flex: 1;\n  }\n"])), function (_a) {
    var isPushed = _a.isPushed;
...
var Panel = function (props) {
    ...
    return (React__default['default'].createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu },
        ...
        React__default['default'].createElement(AuditSection, { isPushed: isPushed },
            React__default['default'].createElement(SolidProofButton, { link: "https://github.com/solidproof/smart-contract-audits/blob/main/SmartContract_Audit_Solidproof_GuitarSwapToken.pdf" }),
            React__default['default'].createElement(EtherAuthorityButton, { link: "https://github.com/guitar-swap/audit/blob/main/GuitarSwap%20Protocol%20-%20Smart%20Contracts%20Security%20Audit%20Report.pdf" })),
...
var NoProfileMenuIcon = function () { return (React__default['default'].createElement(MenuIconWrapper, { borderColor: "primary" },
    React__default['default'].createElement(Icon$w, { color: "primary", width: "24px" }))); };
...
var WarningMenuIcon = function () { return (React__default['default'].createElement(MenuIconWrapper, { borderColor: "warning" },
    React__default['default'].createElement(Icon$z, { color: "warning", width: "24px" }))); };
var DangerMenuIcon = function () { return (React__default['default'].createElement(MenuIconWrapper, { borderColor: "failure" },
    React__default['default'].createElement(Icon$z, { color: "failure", width: "24px" }))); };
...
exports.CheckmarkCircleIcon = Icon$26;
...
exports.TokenPocketIcon = Icon$I;
...
exports.WalletConnectIcon = Icon$y;
exports.WalletFilledIcon = Icon$w;
